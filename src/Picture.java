...
public class Picture extends SimplePicture 
{
  ...
  /** Method to invert all the colors */
  public void negate() 
  {
	Pixel[][] pixels = this.getPixels2D();
	for (Pixel[] rowArray : pixels)
  ...
  public void grayscale() 
  {
	...
	for (Pixel[] rowArray : pixels)
	{
	  for (Pixel pixelObj : rowArray)
	  {
		int shadeOfGray = (pixelObj.getRed() +pixelObj.getGreen() + pixelObj.getBlue()) / 3;
	  	pixelObj.setRed(shadeOfGray);
		pixelObj.setGreen(shadeOfGray); 
		pixelObj.setBlue(shadeOfGray);
	  }
	}
  }
  ...
  /** mirrors the picture across the center horizontal axis */
  ...
  /** mirrors the bottom of the picture to the top. */
  ...
  /** mirrors across a diagonal line. */
  ...
  public void copy(Picture fromPic, int startRow, int startCol)
  {
         ...
         fromRow++, toRow++)
    {
  	...
  	public void copy(Picture originPic, int startRow, int startCol, int endRow, int endCol)
  	{
  		Pixel fromPixel = null;
  		Pixel toPixel = null;
  		Pixel[][] toPixels = this.getPixels2D();
